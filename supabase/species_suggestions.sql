-- Phylo: species & alias suggestion queues
...
-- Users: insert and read own suggestions
...
-- Admins: read and update all suggestions
...
-- ── Restrict direct species creation to admins only ──────────────────────────
