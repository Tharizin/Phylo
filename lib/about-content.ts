...
export const whyItMattersSections: AboutSection[] = [
    ...
    paragraphs: [
      {
        ...
        linkKeys: ["flagship"],
        links: [{ label: "read the flagship paper here", href: "#" }],
      },
    ],
    bullets: [
  ...
  },
  {
    ...
    paragraphs: [
      {
        text: "Another paper ({metabolic}) found diet diversity to be correlated with lower risk of metabolic diseases like obesity, high blood pressure, and type II diabetes. This is actually a stronger correlation than that of dietary quality. This means that it might actually be better to prioritize eating diversely rather than seeking out the highest quality, most artisanal products.",
        linkKeys: ["metabolic"],
        links: [{ label: "Another paper", href: "#" }],
      },
    ],
  },
  {
    ...
    paragraphs: [
      {
        ...
        linkKeys: ["alali"],
        links: [{ label: "Alali & Shori, 2026", href: "#" }],
      },
      {
        ...
        linkKeys: ["kriss"],
        links: [{ label: "Kriss et al., 2019", href: "#" }],
      },
    ],
  },
  {
    ...
    paragraphs: [
      {
        text: "One final thing: if you shoot for at least 30 plant species per week, you’ll inevitably be consuming a good amount of fiber, whose benefits for gut and overall health are undisputed. This 2024 review paper ({fiber}) went through 64 different studies and found that your risk of dying of cardiovascular disease, cancer, or any other cause were decreased by over 20% for individuals who ate a higher fiber diet. In general, getting more than 25g of dietary fiber per day is a good target.",
        linkKeys: ["fiber"],
        links: [{ label: "2024 review paper", href: "#" }],
      },
    ],
  },
];
